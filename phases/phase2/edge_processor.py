...
class EdgeProcessor:
    def __init__(self):
        ...
        os.makedirs(self.output_dir + "edge_logs", exist_ok=True)
    ...
    def process_hardware_data(self, input_data):
        ...
        processed = {
            ...
            "temperature_filtered": self._moving_average(input_data["temperature_c"], window=5),
            "pressure_anomalies": self._detect_anomalies(input_data["pressure_bar"], threshold=2.0),
            "current_compressed": self._compress_data(input_data["current_a"], factor=5),
    ...
    def _compress_data(self, data, factor=5):
